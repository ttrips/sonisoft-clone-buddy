    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">Sonisoft</h3>
            ...
            <div className="flex space-x-4">
              ...
              <a href="#" className="text-gray-300 hover:text-white transition-colors">
                ...
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723 10.059 10.059 0 01-3.127 1.184A4.92 4.92 0 0016.327 2a4.92 4.92 0 00-4.928 4.927c0 .391.044.77.128 1.13A13.986 13.986 0 012.8 3.6a4.896 4.896 0 00-.667 2.475A4.92 4.92 0 004.4 10.48a4.9 4.9 0 01-2.215-.612v.06A4.922 4.922 0 006.268 14.8a4.908 4.908 0 01-2.202.084 4.93 4.93 0 004.6 3.42A9.86 9.86 0 012 20.29a13.95 13.95 0 007.548 2.212c9.142 0 14.307-7.721 13.995-14.646A10.025 10.025 0 0024 4.89z" />
                </svg>
              </a>
              <a href="#" className="text-gray-300 hover:text-white transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">DevOps Solutions</a></li>
            </ul>
          </div>
          <div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-sm text-gray-400">
          <p>© {new Date().getFullYear()} Sonisoft. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
